    ...
    <div className="btns">
      ...
      <Link to={`/users/${id}`}>
        <div style={{ backgroundColor: "", padding: "0px 20px 0px 10px" }}>
          <span className="navbar-stats">{user?user.reputation:0}</span>
          <span>
            {" "}
            <FaCircle
              style={{
          ...
          <span className="navbar-stats">{badgeCount.Gold}</span>
          <span>
            {" "}
            <FaCircle
              style={{
          ...
          <span className="navbar-stats">{badgeCount.Silver}</span>
          <span>
            {" "}
            <FaCircle
              style={{
          ...
          <span className="navbar-stats">{badgeCount.Bronze}</span>
        </div>
      </Link>
      <Link
        to={"/messages"}
      ...
      >
        <FiLogOut
          style={{ marginTop: "5px", fontSize: "18px", color: "#fff" }}
        />
      </Link>
    </div>
  );
